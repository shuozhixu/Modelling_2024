...
Third, build 41 subdirectories by

	sh build.sh

Fourth, submit 41 jobs by

	sh run.sh
	
Once all calculations are finished, edit line 14 of the file `gsfe_curve.sh`; by default, `c` equals 1, change the value of `c` to
